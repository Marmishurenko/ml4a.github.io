...
[Ада Лавлейс](https://ru.wikipedia.org/wiki/Лавлейс,_Ада) описала замысел создания «математического анализа нервной системы» за столетие до первого внедрения нейронных сетей. Умозрительные аналогии между мозгом и машиной так же стары, как и сама вычислительная философия; однако, идея о том, что вычислительные машины могут обладать чуть ли не человеческими когнитивными способностями, не приходила никому на ум до [Чарльза Бэббиджа] (https://ru.wikipedia.org/wiki/Бэббидж,_Чарлз) и его [«аналитической машины»] (https://ru.wikipedia.org/wiki/Разностная_машина_Чарльза_Бэббиджа#.D0.90.D0.BD.D0.B0.D0.BB.D0.B8.D1.82.D0.B8.D1.87.D0.B5.D1.81.D0.BA.D0.B0.D1.8F_.D0.BC.D0.B0.D1.88.D0.B8.D0.BD.D0.B0). Ада не дожила до исполнения своей мечты о вычислительном устройстве — инженеры в то время не могли создать сложные электросхемы, которыe требовал замысел. Тем не менее, идея получила развитие в следующем веке, вдохновив [Алана Тьюринга](https://ru.wikipedia.org/wiki/Тьюринг,_Алан) на [«Имитационную игру»] (http://phil415.pbworks.com/f/TuringComputing.pdf), позднее известную как [тест Тьюринга](https://ru.wikipedia.org/wiki/Тест_Тьюринга). Размышления Тьюринга о предельных возможностях вычислительных машин спровоцировали первый бум искусственного интеллекта и подготовили площадку для наступления золотого века нейронных сетей. 
...
##Властители умов прошлого и грядущего

Недавнее возрождение интереса к нейронным сетям — забавная история. Будучи тесно связанными с зарождением искусственного интеллекта, нейронные сети впервые были концептуально сформированы в виде тьюринговских машин [Б-типа (B-type machines)](https://en.wikipedia.org/wiki/Unorganized_machine). Машины Б-типа базировались на ранних исследованиях неврологов и когнитивных психологов в области [нейропластичности](https://en.wikipedia.org/wiki/Hebbian_theory) (особенности когнитивных процессов у людей). После открытия законов развития человеческого мозга, ученые-программисты начали эксперименты с идеализированными вариантами [метода обратного распространения ошибки] (https://ru.wikipedia.org/wiki/Метод_обратного_распространения_ошибки) и [потенциала действия] (https://ru.wikipedia.org/wiki/Потенциал_действия) для симуляции схожих процессов в компьютере.

Сегодня большинство ученых предостерегают от буквального понимания этой аналогии. Нейронные сети однозначно ориентированы на решение проблем машинного обучения, а не на точную симуляцию мозговых процессов. Однако сравнение базовой единицы нейронных сетей с упрощенным биологическим нейроном прижилось за десятки лет. Эволюцию термина от биологических до искусственных нейронов можно выразить следующим образом:
